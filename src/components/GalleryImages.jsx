...
const GalleryImages = () => {
  return (
    <div>
      <div className="containerr AnimatedBg mb-20">
        <aside className="carousel">
          <div className="carousel__wrapper pb-1">
            ...
            <div className="item" id="slide-3">
              <img
                src="https://i.imgur.com/QRR0haU.jpg"
                width={418}
                height={418}
              />
            </div>
            <div className="item" id="slide-4">
              <img
                src="https://i.imgur.com/zCuqkSr.jpg"
                width={418}
                height={418}
              />
            </div>
            <div className="item" id="slide-5">
              <img
                src="https://i.imgur.com/pXvEksF.jpg"
                width={418}
                height={418}
              />
            </div>
            <div className="item" id="slide-6">
              <img
                src="https://i.imgur.com/i84CY5T.jpg"
                width={418}
                height={418}
              />
            </div>
            <div className="item" id="slide-7">
              <img
                src="https://i.imgur.com/WyQ3qFI.jpg"
                width={418}
                height={418}
              />
            </div>
            <div className="item" id="slide-8">
              <img
                src="https://i.imgur.com/CbzPb6d.jpg"
                width={418}
                height={418}
              />
            </div>
            <div className="item" id="slide-9">
              <img
                src="https://i.imgur.com/9Kq3ipA.jpg"
                width={418}
                height={418}
              />
            </div>
        ...
        <article className="instagram">
          <a
            href="https://www.instagram.com/seasofcelebrations/"
            target="_blank"
