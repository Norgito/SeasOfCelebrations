        ...
        <div className="card z-0">
          ...
          <div className="content z-0">
            ...
            <p className="text-[15px]">
              ...
              memorable atmosphere. We offer custom designs and colors to add a
        ...
        <div className="card lg:scale-110">
          ...
          <div className="content">
            ...
            <p className="text-[15px]">
              ...
              including tables, chairs, tents, lighting, and more. We create the
              ideal atmosphere for weddings and parties.
            </p>
          </div>
        </div>
        <div className="card z-0">
          <div className="icon">
            <img src={Conf} alt="Confetti Product" className="w-[100px] z-10" />
          </div>
          <div className="content">
            <h2 className="bg-white/30 rounded-full py-2">
